...
cd             ~/data/alignment
perl           ~/Scripts/withncbi/taxon/strain_bz.pl \
    --file     ~/data/alignment/fly65/fly65.csv      \
    -w         ~/data/alignment                      \
    --name     fly65                                 \
    --use_name \
    -t         Dmel                                  \
...
sh fly65/1_real_chr.sh
    
#----------------------------------------------------------#
# arabidopsis
#----------------------------------------------------------#
cd ~/data/alignment/arabidopsis65

perl       ~/Scripts/withncbi/taxon/strain_info.pl \
    --file arabidopsis65.csv                       \
    --id   3702                                    \
    --id   59689

# change strain names to Atha and Alyr

cd             ~/data/alignment
perl           ~/Scripts/withncbi/taxon/strain_bz.pl            \
    --file     ~/data/alignment/arabidopsis65/arabidopsis65.csv \
    -w         ~/data/alignment                                 \
    --name     arabidopsis65                                    \
    --use_name \
    -t         Atha                                             \
...
sh arabidopsis65/1_real_chr.sh
