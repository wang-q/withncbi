...
|:---------------|:---------------------------|-----------:|:-----------|--------:|
| Actinobacteria |                            |            |            |         |
|                | Mycobacterium canetti      |      78331 | 卡氏分枝杆菌 |       9 |
|                | Mycobacterium mungi        |    1844474 |            |         |
|                | Mycobacterium orygis       |    1305738 |            |       1 |
|                | Mycobacterium tuberculosis |       1773 | 结核分支杆菌 |     196 |

| Subspecies                                 |     ID | Comments        | Strains |
|:-------------------------------------------|-------:|:----------------|--------:|
| Mycobacterium tuberculosis var. africanum  |  33894 | 非洲分枝杆菌      |      26 |
| Mycobacterium tuberculosis var. bovis      |   1765 | 牛分枝杆菌, 卡介苗 |      22 |
| Mycobacterium tuberculosis var. caprae     | 115862 |                 |       1 |
| Mycobacterium tuberculosis var. microti    |   1806 | 仓鼠分枝杆菌      |       2 |
| Mycobacterium tuberculosis var. pinnipedii | 194542 |                 |       1 |
...
mysql -ualignDB -palignDB ar_refseq -e "
    ...
    WHERE 1=1
        ...
        AND species_id in (78331, 1844474, 1305738, 1773)
    " \
    > raw.tsv
...
# gff
for n in M_can_CIPT_140010059 M_tub_H37Rv \
