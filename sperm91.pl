...
perl [% pl_dir %]/alignDB/extra/two_way_batch.pl -d Dictyvs[% item.name %] -t="44689,Dicty" -q "[% item.taxon %],[% item.name %]" -a [% data_dir %]/Dictyvs[% item.name %] -at 10000 -st 0 --parallel 8 --run 1-3,21,40
